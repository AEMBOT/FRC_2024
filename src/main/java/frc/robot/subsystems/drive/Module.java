...
public class Module {
  ...
  public Module(ModuleIO io, int index) {
    ...
    switch (Constants.currentMode) {
      ...
      case REPLAY:
        ...
        break;
      case SIM:
        driveFeedforward = new SimpleMotorFeedforward(0.0, 0.14);
        driveFeedback = new PIDController(0.6, 0.0, 0.0);
  ...
  @AutoLogOutput(key = "Module{index}/DriveVelocityMetersPerSec")
